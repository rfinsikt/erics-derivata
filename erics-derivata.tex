...
\begin{exempel}
    Derivera funktionen $f(x) = 3x^2$ \dinkus Svar: \[f'(x) = 3\cdot 2x^{2-1} = 6x\]
\end{exempel}

\begin{exempel}
    Derivera funktionen $f(x) = 3$ \dinkus Svar: \[f(x) = 3 \cdot x^0 \imp f'(x) = 3 \cdot 0 = 0\]
\end{exempel}
...
\begin{exempel}
    \label{ex:3x2}
    Derivera funktionen $f(x) = 3x^2 + x^3$ \dinkus Svar: \[f'(x) = 6x + 3x^2\]
\end{exempel}
...
\begin{exempel}
    \label{ex:x^1/3}
    Derivera funktionen $f(x) = x^{-2} + x^{\frac 13} + x^{2,35}$
    \dinkus
    Svar:
...
\begin{exempel}
    Derivera funktionen $f(x) = \dfrac 1{e^x}$
     \dinkus
...
\begin{exempel}
    Derivera funktionen $f(x) = \dfrac 2{4^{2x}}$
    \dinkus
    Lösning: Vi börjar med att skriva om $f(x)$ med hjälp av potensregler (se Appendix \ref*{app:pot} på sidan \pageref*{app:pot}).
...
\begin{exempel}
    Funktionen $f(x) = \sqrt{x}$ kan inte deriveras med vanliga deriveringsregler --- men med hjälp av potensreglerna kan vi skriva om det:

    \[\sqrt{x} = x^{\frac 12}\]

    $f(x) = x^{\frac 12}$ kan deriveras med regel \ref*{reg:e^x} på sidan \pageref*{reg:e^x} och \ref*{reg:kf(x)} på sidan \pageref*{reg:kf(x)}.
\end{exempel}
...
\begin{facit}
    \begin{multicols}{3}
        \begin{enumerate}
            ...
            \item $g'(x) = -\dfrac 1{x^2} - \dfrac 2 {x^3}$
            \item $h'(x) = 2x^{-0,5}$
        \end{enumerate}
    \end{multicols}
\end{facit}
